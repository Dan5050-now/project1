...
const steps = [
  ...
  ["STEP 2", "Programming spec", "TEA-SPEC-001", "Approved 21 Aug", "done"],
  ["STEP 3", "Prototype output", "Dummy dataset", "Next - needs a pilot study", "now"],
...
s.addText("Step 2 closed. Step 3 next.", {
...
s.addNotes("The approval was a reasonableness review, not line-by-line. That is workable because Step 3 confirms the detail by evidence - the golden dataset tests all 83 live rules against known expected findings.");
