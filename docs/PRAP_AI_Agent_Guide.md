...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.50 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.53.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.27.xlsx` |
| UI component list | `docs/PRAP_UI_Component_List_v1.0.xlsx` |
| Source data template | `templates/PRAP_SourceData_Template_v1.15.xlsx` |
| Worked example (62 projects, 20 people) | `templates/PRAP_SourceData_Dummy_v1.17.xlsx` |
| Worked example (10 projects, 10 people) | `templates/PRAP_SourceData_Dummy_10x10_v1.9.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-09-12 from `app/PRAP.html` v1.50, `PRAP_Development_Plan_v2.53.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
