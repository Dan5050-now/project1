...
Generated by `tools/build_ai_reference.py` on 2026-09-03 from `app/PRAP.html` v1.37, `PRAP_Development_Plan_v2.39.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
