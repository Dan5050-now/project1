...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.16 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.18.xlsx` |
...
### 9.4 Prepare a workbook for someone to open in the application
...
Generated by `tools/build_ai_reference.py` on 2026-08-06 from `app/PRAP.html` v1.16, `PRAP_Development_Plan_v2.18.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
