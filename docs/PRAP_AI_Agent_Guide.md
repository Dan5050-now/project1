...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.30 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.32.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.6.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-08-26 from `app/PRAP.html` v1.30, `PRAP_Development_Plan_v2.32.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
