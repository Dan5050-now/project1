...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.46 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.48.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.22.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-09-06 from `app/PRAP.html` v1.46, `PRAP_Development_Plan_v2.48.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
