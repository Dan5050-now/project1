...
Generated by `tools/build_ai_reference.py` on 2026-08-26 from `app/PRAP.html` v1.26, `PRAP_Development_Plan_v2.28.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
