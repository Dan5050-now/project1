...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.26 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.28.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.2.xlsx` |
...
| `weight` | text | Effort multiplier. Clinical trial types: seeded from PeriodWeightStandard. Others: type it. |
...
| `assign_start_date` | date | Date the person joins the study. |
| `assign_end_date` | date | Date the person leaves. Blank = runs to project end. |
...
| **V-03** | error | Every Assignment.role_name appears in RoleFactor for that project's type. |
...
Generated by `tools/build_ai_reference.py` on 2026-08-24 from `app/PRAP.html` v1.26, `PRAP_Development_Plan_v2.28.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
