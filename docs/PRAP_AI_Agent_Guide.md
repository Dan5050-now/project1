...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.52.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.26.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-09-12 from `app/PRAP.html` v1.50, `PRAP_Development_Plan_v2.52.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
