...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.58.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.29.xlsx` |
| UI component list | `docs/PRAP_UI_Component_List_v2.1.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-09-13 from `app/PRAP.html` v1.50, `PRAP_Development_Plan_v2.58.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
