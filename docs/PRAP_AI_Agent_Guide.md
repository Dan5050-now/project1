...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.41 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.43.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.17.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-09-04 from `app/PRAP.html` v1.41, `PRAP_Development_Plan_v2.43.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
