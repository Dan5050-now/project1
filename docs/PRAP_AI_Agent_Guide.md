...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.22 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.24.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-08-08 from `app/PRAP.html` v1.22, `PRAP_Development_Plan_v2.24.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
