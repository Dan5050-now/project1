...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.34 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.36.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.10.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-08-28 from `app/PRAP.html` v1.34, `PRAP_Development_Plan_v2.36.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
