...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.43 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.45.xlsx` |
| Programming specification | `docs/PRAP_Programming_Specification_v1.19.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-09-05 from `app/PRAP.html` v1.43, `PRAP_Development_Plan_v2.45.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
