...
|  |  |
|---|---|
| Application | `app/PRAP.html` v1.18 |
...
| What | Path |
|---|---|
| Development plan | `docs/PRAP_Development_Plan_v2.20.xlsx` |
...
Generated by `tools/build_ai_reference.py` on 2026-08-07 from `app/PRAP.html` v1.18, `PRAP_Development_Plan_v2.20.xlsx` and `tools/build_source_workbook.py`. Do not edit by hand — rebuild it.
