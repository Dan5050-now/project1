...
rows = [
    ...
    ["2.40", "2026-09-03", "Claude Code", "Pending",
     ...
     "showed.",
     "Superseded by v2.41"],
    [f"{MARK_NEW}2.50", "2026-09-11", "Claude Code", "Pending",
