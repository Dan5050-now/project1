...
rows = [
    ...
    [f"{MARK_NEW}2.38", "2026-08-30", "Claude Code", "Pending",
     ...
     "figures currently on screen, so nothing jumps, and switching back discards the "
     "lot. That was chosen over per-month marking deliberately - once a figure has been "
