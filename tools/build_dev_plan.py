...
rows = [
    ...
    ["1.5", DOC_DATE, "Claude Code", "Pending",
     ...
     "Superseded by v1.6"],
    [f"{MARK_NEW}2.40", "2026-09-03", "Claude Code", "Pending",
...
asg = [
    ...
    [f"{MARK_NEW}estimation_type", "List", "No", "SCHEMA 9. 'automatic' (the default) or 'manual'. Manual means THIS PERSON'S contribution to this project is stated on MonthlyEstimate rather than multiplied out - the level below the project's own, and applied first (REQ-CAL-18).", "REQ-CAL-18"],
    [f"{MARK_NEW}estimation_type", "List", "No", "SCHEMA 9. 'automatic' (the default) or 'manual'. Manual means THIS PERSON'S contribution to this project is stated on MonthlyEstimate rather than multiplied out - the level below the project's own, and applied first (REQ-CAL-18).", "REQ-CAL-18"],
