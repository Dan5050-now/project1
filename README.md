...
|---|---|---|
| 1 | Development plan | **v2.0 APPROVED BASELINE** 2026-08-02 · v2.4 records Step 4 progress |
...
- `docs/PRAP_Development_Plan_v2.4.xlsx` — **current.** 70 requirements, 24 validation
