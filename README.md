...
| Step | Description | State |
|---|---|---|
| N1 | Development plan | `docs/PRAP_NewApp_Development_Plan_v0.1.xlsx` — **draft, issued for review** |
...
- `docs/PRAP_NewApp_Development_Plan_v0.1.xlsx` — **draft, awaiting your review.**
  13 sheets: 33 requirements (NR-ids), the one-engine/two-shells architecture, the
  workspace persistence model and its write protocol, 12 engineering decisions
  (N-01…N-12), 8 risks, a five-gate work breakdown and 11 open questions. Generated by
